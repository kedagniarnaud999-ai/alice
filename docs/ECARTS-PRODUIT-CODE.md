# AliTché — là où mon document et le produit ne disent pas la même chose
...
Ce fichier n'annonce aucune correction. Il pose neuf constats en face de neuf phrases de mon document de
cadrage (`docs/CADRAGE-PRODUIT.md`). Quatre portent une réponse depuis le 2026-09-23 — les points 2, 4, 5
et 6. Les cinq autres attendent la leur, à une ligne chacun, à écrire à la place de « Ma décision ».

Trois réponses reviennent pour presque tous les points :

- **le finir** — c'est ce que je veux, le produit l'a commencé, on termine ;
- **le retirer** — ça n'est pas ce que je veux, ou pas maintenant, on l'enlève de ce que le visiteur voit ;
...
devant un candidat, et c'est exactement ce que je veux éviter.

---

## 1. Le questionnaire : six dimensions annoncées, cinq groupes construits

**Ce que dit mon document.** Chapitre 7, module 1 : le questionnaire comporte six dimensions — profil
...
psychologique, intérêts, aptitudes, contraintes. Mes six dimensions sont toutes couvertes, mais deux
d'entre elles — motivations et talents naturels — tombent dans un seul groupe côté produit, et un groupe côté
produit — les contraintes (temps, argent, obstacle) — n'existe pas dans ma liste.
...
mon document, si. Une dimension que personne ne compte n'est pas une dimension, c'est une phrase.
...
**Ce que dit mon document.** Chapitre 13 : « le parcours utilisateur principal est presque atteint », « la
priorité n'est plus de réinventer le parcours ».

**Ce que le produit fait.** Le parcours fonctionne. Il a été essayé des centaines de fois — par moi, qui l'ai
construit. Zéro utilisateur hors de l'équipe, à ma connaissance, a fait les 31 questions jusqu'au
bout sans qu'on le guide.

**Ce que je propose.** Garder ma conclusion — ne pas réinventer le parcours — mais changer la preuve.
...
**Ma décision.** *Prise le 2026-09-23 : cinq personnes hors de l'équipe, cette semaine.* Le protocole
...
**Ce que dit mon document.** Chapitre 13, dans ce qui est déjà développé : « premières briques de formation ».
...
**Ce que dit mon document.** Chapitre 19, ce qu'il ne faut pas développer maintenant, et chapitre 26 : le
...
données pour ne pas avoir à la reconstruire le jour où je décide ce qui est payant. Un visiteur qui voit
...
**Ma décision.** *Prise le 2026-09-23 : l'étiquette est retirée de l'affichage. La distinction reste dans les
...
**Ce que dit mon document.** Chapitre 7, module 4 : la plateforme doit permettre d'intégrer des modules de
...
et de pédagogie, pas de code, et qui demande un auteur. La première question de ma règle du chapitre 20 —
quel problème utilisateur cela résout-il ? — fait pencher la balance vers « orienter » d'abord.

**Ma décision.** *Prise le 2026-09-23, en trois temps : d'abord orienter — AliTché renvoie vers des formations
qui existent ailleurs. Ensuite, les centres de formation et les universités pourront proposer leurs contenus,
qu'AliTché référence. Et à une étape où l'on en aura la capacité, on pourra produire des modules en interne
...
**Ce que dit mon document.** Chapitre 13, ce qui est déjà développé : « création de compte ». Le document ne
...
**Ma décision.** *Prise le 2026-09-23 : le lien de connexion sans mot de passe est retiré. La connexion Google
...
l'adresse de retour. Ce qu'il fallait préparer : les valeurs exactes à coller, l'adresse de retour, et l'écran qui affiche le
bouton. Ce qui reste : les deux consoles. → tâche S2.2.
...
**Ce que dit mon document.** Chapitre 15, priorité 1 : la chaîne inscription → profil → orientation doit être
...
pas la mienne, le message ouvert, le clic fait, le résultat noté. C'est deux heures de travail et c'est ce qui
...
**Ce que dit mon document.** Chapitre 7, module 5 : « les compétences constituent un élément central du
...
**Ce que je propose.** C'est le point où mon document décrit l'avenir et où le code n'en a pas même la
...
doublon, construite depuis ce que mes 51 modules disent déjà.
...
| 2 | « le parcours est presque finalisé » | oui, par une preuve | prise : cinq personnes cette semaine | S1.6, S3.7 |
| 3 | les briques de formation déjà développées | non | en attente | S1.5 |
| 4 | l'étiquette de prix « Premium » | non | prise et faite : retirée de l'écran, conservée dans les données | S1.5 |
| 5 | héberger des cours ou orienter vers des cours | **oui — tout le sprint 5 en dépend** | prise : orienter, puis référencer, puis produire | S5.1 |
