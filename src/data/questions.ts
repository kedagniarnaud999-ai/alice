...
export const orientationQuestions: Question[] = [
  ...
  },
  {
    ...
    type: 'single',
    options: [
      { id: 'o_plan', text: 'Je planifie tout à l’avance, avec des listes', weights: { structured: 3, organizational_talent: 2 } },
      { id: 'o_priority', text: 'Je m’adapte aux priorités du moment', weights: { adaptive: 3, pragmatic: 1 } },
      { id: 'o_blocks', text: 'Je travaille par blocs d’activités similaires', weights: { structured: 2, analytical: 1 } },
      { id: 'o_inspire', text: 'Je commence par ce qui m’inspire le plus', weights: { intuitive: 3, creative_talent: 2 } },
    ],
  },
  {
    id: 'q_team_role',
    ...
    type: 'single',
    options: [
      { id: 'r_leader', text: 'Je décide, je coordonne, je porte le résultat', weights: { leadership: 3, organizational_talent: 2 } },
      { id: 'r_idea', text: 'J’apporte les idées et les concepts nouveaux', weights: { creative_talent: 3, innovation: 2 } },
      { id: 'r_exec', text: 'Je fais avancer la partie technique, le concret', weights: { technical_talent: 3, pragmatic: 2 } },
      { id: 'r_glue', text: 'Je veille à ce que chacun soit entendu et motivé', weights: { interpersonal_talent: 3, collaborative: 2 } },
      { id: 'r_spokes', text: 'Je rédige, je présente, je convaincs', weights: { communication_talent: 3, linguistic_talent: 1 } },
    ],
  },
  {
    id: 'q_easy_skill',
