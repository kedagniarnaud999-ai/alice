...
export const orientationQuestions: Question[] = [
  // ─────────────────────────────── 1. SITUATION ───────────────────────────────
  {
    ...
    options: [
      {
        id: 's_bachelier',
        text: "Je viens d'avoir mon bac, ou je suis en train de le passer, et je cherche mon orientation après le bac",
        sets: { situation: 'bachelier' },
      },
      {
        id: 's_diplome',
        text: "J'ai terminé une formation et je cherche un emploi, que ce soit juste après l'école ou depuis plusieurs mois",
        sets: { situation: 'jeune_diplome' },
      },
      {
        id: 's_reconversion',
        text: 'Je travaille déjà et je veux changer de métier',
        sets: { situation: 'reconversion' },
      },
      {
        id: 's_pro',
        text: "J'ai déjà un métier et je veux évoluer ou monter en compétences",
  ...
  },
  {
    ...
    options: [
      { id: 'bac_s', text: 'Série S, scientifique', domains: { ingenierie: 2, ict: 1, sante: 1, finance: 1 } },
      { id: 'bac_t', text: 'Série T, technique', domains: { ingenierie: 2, logistique: 1 } },
      { id: 'bac_litt', text: 'Série L, littéraire', domains: { education: 2, commerce_marketing: 1, administration: 1 } },
      { id: 'bac_es', text: 'Série ES, économique et sociale', domains: { finance: 2, administration: 2, commerce_marketing: 1 } },
      { id: 'bac_st2s', text: 'Série ST2S, sanitaire et social', domains: { sante: 2, social: 2, education: 1 } },
  ...
  },
  {
    ...
    options: [
      { id: 'tr_manage', text: 'Encadrer une équipe', domains: { administration: 2, commerce_marketing: 1 } },
      ...
      { id: 'tr_care', text: "Relation d'aide, service client", domains: { social: 2, sante: 1, tourisme: 1, commerce_marketing: 1 } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 't_technical', text: 'Maîtriser les outils techniques et digitaux', weights: { technical_talent: 3 } },
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        domains: { sante: 1, social: 1, education: 1, tourisme: 1 },
      },
      {
        id: 'e_field',
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        domains: { sante: 1, social: 2, education: 1 },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'm_train', text: 'Former, accompagner, faire monter les autres', functions: { relation: 3 }, domains: { education: 2, sante: 1, social: 1 } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'f_sante', text: 'Santé, soins et prévention', domains: { sante: 3 } },
      { id: 'f_social', text: 'Social et accompagnement', domains: { social: 3 } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'c_hotel', text: 'Hôtellerie, restauration, accueil', domains: { tourisme: 2, sante: 1 } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'fc_health', text: 'Santé, bien-être, soins', domains: { sante: 2 } },
      { id: 'fc_social', text: 'Solidarités, associations, vie communautaire', domains: { social: 2 } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'sp_care', text: 'Un service de soins infirmiers à domicile', domains: { sante: 3 } },
      { id: 'sp_aidedomicile', text: 'Un service d’aide à domicile ou d’accueil de jour', domains: { social: 3 } },
  ...
  },
  {
    id: 'q_exclude',
    stage: 'interests',
    text: "Quels domaines ne voulez-vous pas envisager du tout ? Vous pouvez n'en exclure aucun.",
    type: 'multiple',
    optional: true,
    options: [
      { id: 'x_administration', text: "Je n'envisage pas l'administration ni la gestion", excludes: ['administration'] },
      { id: 'x_commerce', text: "Je n'envisage pas le commerce, la vente ni le marketing", excludes: ['commerce_marketing'] },
      { id: 'x_finance', text: "Je n'envisage ni la finance ni la comptabilité", excludes: ['finance'] },
      { id: 'x_ingenierie', text: "Je n'envisage pas l'ingénierie ni les métiers techniques", excludes: ['ingenierie'] },
      { id: 'x_ict', text: "Je n'envisage pas l'informatique ni le numérique", excludes: ['ict'] },
      { id: 'x_tourisme', text: "Je n'envisage pas le tourisme, l'hôtellerie ni la restauration", excludes: ['tourisme'] },
      { id: 'x_sante', text: "Je n'envisage ni la santé ni les soins", excludes: ['sante'] },
      { id: 'x_social', text: "Je n'envisage ni le social ni l'accompagnement", excludes: ['social'] },
      { id: 'x_education', text: "Je n'envisage pas l'éducation ni la formation", excludes: ['education'] },
      { id: 'x_agriculture', text: "Je n'envisage pas l'agriculture ni l'agroalimentaire", excludes: ['agriculture'] },
      { id: 'x_logistique', text: "Je n'envisage pas le transport ni la logistique", excludes: ['logistique'] },
    ],
  },
  {
  ...
  // ─────────────────────────────── 4. APTITUDE ────────────────────────────────
  {
    ...
    options: [
      ...
      { id: 'ab_care', text: 'Prendre en charge une personne, réaliser des soins', domains: { sante: 3 } },
      { id: 'ab_accompagne', text: "Accompagner une démarche, tenir le dossier d'une situation", domains: { social: 3, administration: 1 } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'al_human', text: "Le contact, l'écoute, le soin", domains: { sante: 2, social: 2, education: 1 } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'r_offline', text: 'Peu ou pas d’accès internet, il me faut du contenu hors-ligne' },
    ],
  },
  {
    id: 'q_constraint',
    ...
    options: [
      ...
      { id: 'constraint_money', text: 'Le budget que représentent les formations' },
