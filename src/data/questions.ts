...
export const orientationQuestions: Question[] = [
  ...
  },
  {
    ...
    options: [
      { id: 'bac_s', text: 'S / Scientifique', domains: { ingenierie: 2, ict: 1, sante: 1, finance: 1 } },
      ...
      { id: 'bac_st2s', text: 'ST2S / Sanitaire et social', domains: { sante: 2, social: 2, education: 1 } },
