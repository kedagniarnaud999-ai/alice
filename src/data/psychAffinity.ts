...
export const PSYCH_DOMAIN_AFFINITY: Record<string, Partial<Record<FunctionalDomainId, number>>> = {
  ...
  collaborative: { education: 2, sante: 2, social: 2, administration: 1, tourisme: 1 },
  ...
  impact: { sante: 3, social: 3, education: 2, agriculture: 1, finance: 1 },
  challenge: { commerce_marketing: 3, ict: 1, ingenierie: 1, logistique: 1 },
  autonomy: { agriculture: 2, ict: 1, commerce_marketing: 1 },
  stability: { administration: 2, finance: 2, sante: 1, social: 1, logistique: 1 },
  learning: { education: 3, ict: 2, ingenierie: 1, sante: 1, social: 1 },
  recognition: { education: 1, sante: 1, social: 1, administration: 1 },
  achievement: { finance: 1, ingenierie: 1, ict: 1, logistique: 1 },
  growth: { education: 2, commerce_marketing: 1, sante: 1, social: 1 },
  ...
  interpersonal_talent: { sante: 3, social: 3, education: 2, tourisme: 2 },
