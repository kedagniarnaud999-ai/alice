...
export const CROSS_OCCUPATIONS: CrossOccupation[] = [
  {
    ...
    sectors: ['agriculture', 'education', 'sante_social'],
  ...
  },
  {
    ...
    sectors: ['commerce_marketing', 'sante_social'],
    functions: ['coordination', 'analyse'],
  ...
  },
  {
    ...
    sectors: ['sante_social', 'agriculture', 'education'],
  ...
  },
  {
    ...
    core: { sante_social: 3, administration: 2 },
  ...
  },
  {
    ...
    sectors: ['sante_social', 'commerce_marketing'],
    functions: ['conception', 'relation'],
  ...
  },
  {
    ...
    sectors: ['sante_social', 'agriculture'],
    functions: ['coordination', 'analyse'],
  ...
  },
  {
    ...
    core: { commerce_marketing: 3, sante_social: 2 },
  ...
  },
  {
    ...
    core: { sante_social: 3, education: 2 },
  ...
  },
  {
    ...
    core: { logistique: 3, sante_social: 2 },
